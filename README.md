...
当前功能：全球城市搜索、当前位置天气、24 小时与 16 天预报、空气质量、生活指数、动态穿衣指南、未来 2 小时风险卡片、过去 7 天与未来 16 天趋势曲线、可选日期历史天气查询、卫星云图、高清城市底图、二维/三维地图、关键道路与城镇名称、地图选点同步天气、雷达回放、温度/湿度/风/气压/降水图层、CMA 与 NHC 台风路径、台风风圈与预报锥、预警列表。地图默认定位所选城市，点击“定位并放大城市细节”即可切换高清城市影像并放大到 12 级左右，之后可继续放大至约 19 级；“3D 城市”显示道路、城市/城镇名称、建筑立体效果和可用的地形起伏，点击地图任意位置会自动回到天气页读取该点天气。云图透明度、风场尺度与阵风提示会随交互变化，放大城市时天气网格自动加密。天气支持手动刷新并约每 15 分钟检查，台风约每 10 分钟检查，地图雷达约每 5 分钟检查。
